...
| `search_index_entries`              | OpenSearch    | internal routing              | Поиск распределяется по shard OpenSearch              |
...
| S3 / Se                 | Репликация объектов между зонами доступности                  | Защита файлов от потери                             |
| OpenSearch | 3+ data nodes, replica shards                                 | Отказоустойчивый поиск                              |
