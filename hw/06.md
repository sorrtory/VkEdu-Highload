...
| `user_sessions`                     | Redis Cluster    | `session:{key}`           | Сессии распределяются нативно по hash slot от session key; высокий read QPS, короткий TTL и бессмысленность репликации |
