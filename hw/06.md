...
| `file_objects`                      | `storage_key_hash`                                                                  | B-Tree                     | Служебная проверка связи с объектным хранилищем; горячий lookup идет по `id` | 2 млрд           | 8 Б          | 2 млрд × (8 + 16)               | 48 ГБ  |
...
| `file_payloads`                     | SeaweedFS / S3   | `storage_key`                    | Объём файлового архива измеряется ПБ, поэтому бинарные объекты распределяются средствами объектного хранилища                                                                                                                                                                                                                               |
